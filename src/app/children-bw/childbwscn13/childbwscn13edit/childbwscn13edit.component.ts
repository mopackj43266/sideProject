...
@Component({
  selector: 'app-childbwscn13edit',
  templateUrl: './childbwscn13edit.component.html',
  styleUrls: ['./childbwscn13edit.component.css', '../../../../assets/css/child.css']
})
export class Childbwscn13editComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<Childbwscn13editComponent>,
  ...
  async uploadFile() {
    ...
    const baseUrl = 'f01/childbwscn13action2';
    if (this.files != null) {
      var mimeType = this.files.type;
      if (mimeType.match(/image\/*/) == null) {
        this.msg = "檔案非圖片類型!";
    ...
    await this.childbwscn13Service.childbwscn13Action(baseUrl, formdata).then((data: any) => {
