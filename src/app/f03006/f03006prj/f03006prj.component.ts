...
//Nick 組織人員維護-儲存角色設定
@Component({
  selector: 'app-f03006prj',
  templateUrl: './f03006prj.component.html',
  styleUrls: ['./f03006prj.component.css', '../../../assets/css/f03.css']
})
export class F03006prjComponent {
  constructor(public dialogRef: MatDialogRef<F03006prjComponent>, public dialog: MatDialog, @Inject(MAT_DIALOG_DATA) public data: any, public f03006Service: F03006Service) { }
  submit() {
  }
  //載入選項
