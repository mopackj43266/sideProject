...
//Jay 組織人員維護 編輯
@Component({
  selector: 'app-f03019edit',
  templateUrl: './f03019edit.component.html',
  styleUrls: ['./f03019edit.component.css', '../../../assets/css/f03.css']
})
export class F03019editComponent {
  ...
  emplist;
  emp;
  constructor(public dialogRef: MatDialogRef<F03019editComponent>,
  ...
  ngOnInit(): void {
    ...
    this.f03019Service.getEmployeeSysTypeCode(baseUrl, jsonObject)
      .subscribe(data => {
  ...
  public async stopEdit(): Promise<void> {
    ...
    msgStr = await this.f03019Service.addorEditSystemCodeSet(baseUrl, this.data);
    const childernDialogRef = this.dialog.open(ConfirmComponent, {
      data: { msgStr: msgStr }
    });
