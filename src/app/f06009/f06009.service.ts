...
export class F06009Service extends BaseService {
  constructor(
    protected httpClient: HttpClient,
    private dialog: MatDialog,
  ) { super(httpClient); }

  private childernDialogRef: MatDialogRef<ConfirmComponent, any>;
  ...
  confrimCom(msg: string) {
    this.childernDialogRef = this.dialog.open(ConfirmComponent, {
      data: { msgStr: msg }
    });
  }
  ...
  getChildernDialogRef() {
    return this.childernDialogRef;
  }
}
